...
import styles from "./frontend/ui/header/badge.module.css";
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body>
        {/*============ header ==================*/}
        <header className="relative shadow-sm p-xsmall w-full md:py-xsmall md:px-large md:grid md:grid-cols-[250px_1fr_20px] md:items-center md:justify-between md:gap-small">
          <Logo />
          <Nav />
          <AuthButton />
        </header>
          ...
          <div className="flex flex-col md:flex-row justify-evently gap-small">
            <div className="flex flex-col justify-evenly w-full md:w-100 md:mr-massive">
              ...
              <p className="text-sm">
                ...
                around the world. Every piece tells a story of craftsmanship and
                creativity.
              </p>
