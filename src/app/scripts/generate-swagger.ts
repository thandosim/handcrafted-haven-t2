  ...
  const spec = {
    ...
    paths: {
      ...
      '/api/seller/products/{id}': {
        ...
        patch: {
          tags: ['Products'],
          summary: 'Update product by ID (seller only)',
          security: [{ bearerAuth: [] }],
          parameters: [
            {
              in: 'path',
      ...
      '/api/reviews': {
        post: {
          ...
          responses: {
            ...
            '401': { description: 'Unauthorized' },
            '403': { description: 'Only verified buyers can review' },
            '422': { description: 'Validation error' }
          }
        }
      },
      '/api/reviews/{id}': {
        patch: {
            ...
            content: {
              'application/json': {
                schema: {
                  type: 'object',
                  properties: {
                    moderatedStatus: { type: 'string', enum: ['approved', 'rejected'] }
                  },
                  required: ['moderatedStatus']
                }
              }
            }
          },
          responses: {
            ...
            '401': { description: 'Unauthorized' },
            '422': { description: 'Invalid moderatedStatus' }
          }
        },
        delete: {
          tags: ['Reviews'],
                ...
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      ...
                      mongoStatus: { type: 'string', example: 'ok' }
                    }
                  }
                }
              }
      ...
      '/api/swagger': {
        get: {
          ...
          responses: {
            ...
            '404': { description: 'Swagger documentation not generated' },
            '500': { description: 'Failed to load documentation' }
          }
        }
      },
      '/api/swagger/docs': {
      ...
      schemas: {
        ...
        Review: {
          ...
          properties: {
            ...
            rating: { type: 'integer', minimum: 1, maximum: 5 },
            text: { type: 'string' },
            moderatedStatus: { type: 'string', enum: ['pending', 'approved', 'rejected'] },
            createdAt: { type: 'string', format: 'date-time' },
            updatedAt: { type: 'string', format: 'date-time' }
          }
        },
